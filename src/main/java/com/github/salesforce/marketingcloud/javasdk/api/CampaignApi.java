...
import com.github.salesforce.marketingcloud.javasdk.model.GetAllCampaignsResponse;
...
public class CampaignApi extends BaseApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Campaign> createCampaignWithHttpInfo( @NotNull Campaign body) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAllCampaignsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAllCampaignsValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        try {
            ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
            ExecutableValidator executableValidator = factory.getValidator().forExecutables();

            Object[] parameterValues = {  };
            Method method = this.getClass().getMethod("getAllCampaignsWithHttpInfo");
            Set<ConstraintViolation<CampaignApi>> violations = executableValidator.validateParameters(this, method,
                    parameterValues);

            if (violations.size() == 0) {
                com.squareup.okhttp.Call call = getAllCampaignsCall(progressListener, progressRequestListener);
                return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GetAllCampaignsResponse getAllCampaigns() throws ApiException {
        ApiResponse<GetAllCampaignsResponse> resp = getAllCampaignsWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetAllCampaignsResponse> getAllCampaignsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getAllCampaignsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<GetAllCampaignsResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * getAllCampaigns (asynchronously)
     * Gets all campaigns.
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAllCampaignsAsync(final ApiCallback<GetAllCampaignsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAllCampaignsValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetAllCampaignsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
