...
public class AssetApi extends BaseApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Asset> createAssetWithHttpInfo( @NotNull Asset body) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Asset> partiallyUpdateAssetByIdWithHttpInfo( @NotNull BigDecimal id,  @NotNull Asset body) throws ApiException {
